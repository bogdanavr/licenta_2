...
RESULTS_CSV = os.path.join(RESULTS_DIR, "controlled_conditions_cpu.csv")
...
def main():
    ...
    print("Loading ONNX model on CPU...")
    ...
    print(f"Started evaluation on CPU | scenariu={SCENARIO_NAME} | run={RUN_ID}")
    try:
        while True:
            ...
            if SHOW_WINDOW:
                ...
                cv2.imshow("CPU Metrics Evaluation", frame)
