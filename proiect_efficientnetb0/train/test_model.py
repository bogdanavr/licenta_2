...
from train.config import EXPORT_DIR, IMAGE_MEAN, IMAGE_STD, IDX2LABEL, IMG_SIZE, SAVED_IMG_SIZE
from train.model import build_model
from train.preprocessing import preprocess_face_rgb
...
def main():
    ...
    processed_rgb, found_face = preprocess_face_rgb(image, SAVED_IMG_SIZE)
    tensor = transform(Image.fromarray(processed_rgb)).unsqueeze(0).to(device)
    ...
    print(f'- fata_detectata: {found_face}')
